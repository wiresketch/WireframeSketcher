...
public class ModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelSwitch<Adapter> modelSwitch =
		new ModelSwitch<Adapter>() {
			...
			@Override
			public Adapter caseVButtonBar(VButtonBar object) {
				return createVButtonBarAdapter();
			}
			@Override
			public Adapter caseAnnotationSupport(AnnotationSupport object) {
				return createAnnotationSupportAdapter();
			}
			@Override
			public Adapter caseTextLinksSupport(TextLinksSupport object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.wireframesketcher.model.VButtonBar <em>VButton Bar</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createVButtonBarAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.wireframesketcher.model.AnnotationSupport <em>Annotation Support</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createAnnotationSupportAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link com.wireframesketcher.model.TextLinksSupport <em>Text Links Support</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
