 ...
 * <ul>
 *   <li>{@link com.wireframesketcher.model.impl.VideoPlayerImpl#getSkin <em>Skin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class VideoPlayerImpl extends WidgetImpl implements VideoPlayer {
	...
	public void setSkin(URI newSkin) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.VIDEO_PLAYER__SKIN, oldSkin, skin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case ModelPackage.VIDEO_PLAYER__SKIN:
				return getSkin();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		if (baseClass == SkinSupport.class) {
			switch (derivedFeatureID) {
				case ModelPackage.VIDEO_PLAYER__SKIN: return ModelPackage.SKIN_SUPPORT__SKIN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		if (baseClass == SkinSupport.class) {
			switch (baseFeatureID) {
				case ModelPackage.SKIN_SUPPORT__SKIN: return ModelPackage.VIDEO_PLAYER__SKIN;
				default: return -1;
			}
		}
