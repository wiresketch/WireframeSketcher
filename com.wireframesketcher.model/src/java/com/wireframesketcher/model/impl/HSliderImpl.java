 ...
 *   <li>{@link com.wireframesketcher.model.impl.HSliderImpl#getSkin <em>Skin</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class HSliderImpl extends WidgetImpl implements HSlider {
	...
	public void setSkin(URI newSkin) {
		...
		skin = newSkin;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.HSLIDER__SKIN, oldSkin, skin));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case ModelPackage.HSLIDER__STATE:
				return getState();
			case ModelPackage.HSLIDER__SKIN:
				return getSkin();
		}
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == SkinSupport.class) {
			switch (derivedFeatureID) {
				case ModelPackage.HSLIDER__SKIN: return ModelPackage.SKIN_SUPPORT__SKIN;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == SkinSupport.class) {
			switch (baseFeatureID) {
				case ModelPackage.SKIN_SUPPORT__SKIN: return ModelPackage.HSLIDER__SKIN;
				default: return -1;
			}
		}
