...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Screen Font</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 ...
 * @generated
 */
public class ScreenFontImpl extends EObjectImpl implements ScreenFont {
	/**
	...
	protected EClass eStaticClass() {
		return ModelPackage.Literals.SCREEN_FONT;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCREEN_FONT__NAME, oldName, name));
	}
	...
	public void setBold(boolean newBold) {
		...
		bold = newBold;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCREEN_FONT__BOLD, oldBold, bold));
	}
	...
	public void setItalic(boolean newItalic) {
		...
		italic = newItalic;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ModelPackage.SCREEN_FONT__ITALIC, oldItalic, italic));
	}
